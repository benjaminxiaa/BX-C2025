...
public class Elevator extends SubsystemBase 
{
  ...
  /**
   * @param desired desired position, in rotations
   */
  ...
  /**
   * @param desired the distance to check, in rotations
   * @return whether or not the elevator is done extending to a specific 
   *		 point
   */
  ...
  /**
   * @return stored position of the motor, in rotations
   */
  ...
  /**
   * 
   * @param power proportion of voltage supplied in range [-1, 1]
   */
  ...
  /**
   * @return whether or not to stop extension, according to the limit switch
   */
